    ...
    <div class="row">
      <div class="col-sm-5">
        <div class="film-titles">
          ...
          <div class="film-wrapper" data-id="helium">
            <router-link class="film-title" to="/directing/helium">
              Helium (2022)
            </router-link>
          </div>

          <div class="film-wrapper" data-id="bjgg">
            <router-link class="film-title" to="/directing/bjgg">
